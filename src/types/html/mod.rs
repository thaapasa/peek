...
//!
//! `HtmlRenderer` (default) renders the document via `html2text` —
...
//! tags, wrapped in the generic `RenderedTextMode`. `ContentMode`
//! (paired) shows the raw HTML source with XML syntax highlighting.
//!
...
pub(crate) use renderer::HtmlRenderer;
