...
use peek_types::types::eps::dos_eps::PreviewKind;
use peek_types::types::eps::gs;
...
fn gather_fixture(rel: &str) -> peek_foundation::info::FileInfo {
...
fn jpeg_cozy_room_has_dimensions_icc_and_exif() {
    ...
    let stats = peek_foundation::info::downcast_extras::<peek_types::types::image::info::ImageStats>(
        &info.extras,
    );
...
fn svg_calendar_extras() {
    ...
    let stats = peek_foundation::info::downcast_extras::<peek_types::types::svg::info::SvgStats>(
        &info.extras,
    );
...
fn json_config_top_level_object() {
    ...
    let info = peek_foundation::info::downcast_extras::<
        peek_types::types::structured::info::StructuredInfo,
    >(&info.extras);
...
fn rust_theme_text_metrics() {
    ...
    let stats = peek_foundation::info::downcast_extras::<peek_types::types::text::info::TextStats>(
        &info.extras,
    );
...
fn css_styles_sidecar_stats() {
    ...
    let css = peek_foundation::info::downcast_extras::<peek_types::types::css::info::CssInfo>(
        &info.extras,
    );
    let stats = &css.stats;
...
fn sqlite_library_catalogue_stats() {
    ...
    let sqlite = peek_foundation::info::downcast_extras::<
        peek_types::types::sqlite::info::SqliteInfo,
    >(&info.extras);
...
fn java_classfile_sample_metadata() {
    ...
    let cf = peek_foundation::info::downcast_extras::<
        peek_types::types::classfile::info::ClassfileInfo,
    >(&info.extras);
...
fn postscript_sample_ps_dsc_and_no_preview() {
    ...
    let info = gather(&source, &detected).expect("gather");
    let eps =
        peek_foundation::info::downcast_extras::<peek_types::types::eps::EpsInfo>(&info.extras);
...
fn bonfire_nature_ai_is_illustrator_pdf() {
    ...
    let pdf =
        peek_foundation::info::downcast_extras::<peek_types::types::pdf::PdfStats>(&info.extras);
...
fn xlsx_people_workbook_lists_sheets_and_metadata() {
    ...
    let wb = peek_foundation::info::downcast_extras::<
        peek_types::types::spreadsheet::SpreadsheetInfo,
    >(&info.extras);
...
fn eml_sample_detects_and_gathers() {
    ...
    let info = gather(&source, &detected).expect("gather");
    let email =
        peek_foundation::info::downcast_extras::<peek_types::types::email::EmailInfo>(&info.extras);
