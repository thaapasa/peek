...
impl WrapScroll {
    pub(crate) fn new(soft_wrap: bool) -> Self {
        Self {
            soft_wrap,
            top_logical: 0,
            top_sub_row: 0,
    ...
    pub(crate) fn top_logical(&self) -> usize {
        self.top_logical
    }
    ...
    pub(crate) fn first_skip(&self) -> usize {
    ...
    pub(crate) fn jump_to_line(&mut self, line: usize) {
    ...
    pub(crate) fn set_h_scroll(&mut self, h: usize) {
        self.h_scroll = h;
    }

    pub(crate) fn clear_h_scroll(&mut self) {
        self.h_scroll = 0;
    }
...
#[cfg(test)]
impl WrapScroll {
    pub(crate) fn top_sub_row(&self) -> usize {
        self.top_sub_row
    }
