...
fn registered_for_type(file_type: &FileType) -> Option<&'static str> {
    Some(match file_type {
        ...
        FileType::Csv(crate::CsvFormat::Csv) => "text/csv",
        FileType::Csv(crate::CsvFormat::Tsv) => "text/tab-separated-values",
        FileType::Cert(crate::CertFormat::Pem) => "application/x-pem-file",
        FileType::Cert(crate::CertFormat::Der) => "application/pkix-cert",
        FileType::Cert(crate::CertFormat::Jwk) => "application/jwk+json",
        FileType::Font(crate::FontFormat::TrueType) => "font/ttf",
        FileType::Font(crate::FontFormat::OpenType) => "font/otf",
        FileType::Font(crate::FontFormat::Collection) => "font/collection",
        FileType::Font(crate::FontFormat::Woff) => "font/woff",
        FileType::Font(crate::FontFormat::Woff2) => "font/woff2",
...
fn known_extensions_for_type(file_type: &FileType) -> &'static [&'static str] {
    match file_type {
        ...
        FileType::VObject(crate::VObjectFormat::ICal) => &["ics", "ical", "ifb"],
        FileType::VObject(crate::VObjectFormat::VCard) => &["vcf", "vcard"],
        FileType::Cert(_) => &[
