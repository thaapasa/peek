...
pub fn find_matches(haystack: &str, query: &str, sensitive: bool) -> Vec<Range<usize>> {
...
impl SearchState {
    ...
    pub fn line_overlay(&self, line: usize) -> Option<(Vec<Range<usize>>, Option<usize>)> {
...
pub fn reveal_h_scroll(h_scroll: usize, cols: usize, start: usize, end: usize) -> usize {
    if cols == 0 {
