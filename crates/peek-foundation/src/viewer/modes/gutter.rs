...
impl Gutter {
    ...
    pub fn visible_width(&self, total: usize) -> usize {
    ...
    pub fn prefix(&self, line_num: Option<usize>, total: usize, theme: &PeekTheme) -> String {
        if !self.enabled || total == 0 {
            return String::new();
        }
    ...
    pub fn apply(&self, lines: &mut [String], start: usize, total: usize, theme: &PeekTheme) {
